...
- 20 世纪 70 年代
  ...
  * ~1970 – Pascal
  * ~1972 – C
  * [1979](https://web.archive.org/web/20181223062837/http://heim.ifi.uio.no/~trygver/1979/mvc-2/1979-12-MVC.pdf) – **MVC 模式(Model-View-Controller)**
- 20 世纪 80 年代
  * **面向对象编程** (但其思想在 [20世纪60年代](https://web.archive.org/web/20180424095400/http://userpage.fu-berlin.de/~ram/pub/pub_jf47ht81Ht/doc_kay_oop_en)晚期已经第一次提出)
  ...
  * [1988](https://drive.google.com/uc?export=download&id=0BwhCYaYDn8EgNzAzZjA5ZmItNjU3NS00MzQ5LTkwYjMtMDJhNDU5ZTM0MTlh) – **LSP(里氏替换原则)** (~SO**L**ID)
- 20 世纪 90 年代
  * **分层**: **三层**，第一层是用户界面，第二层是业务逻辑(以及浏览器作为客户端时的用户界面展现逻辑)，第三层是数据存储
  * ~1991 – **消息总线**
  * ~1991 – Python
  * [1992](https://www.amazon.com/dp/0201403471) – **EBI 架构**(Entity-Boundary-Interactor) 即 EBC 或 EIC
  * ~1993 – Ruby
  * ~1995 – Delphi, Java, Javascript, PHP
  * [1996](https://web.archive.org/web/20181105001712/http://www.wildcrest.com/Potel/Portfolio/mvp.pdf) – **MVP 模式(Model-View-Presenter)**
  * [1996](https://web.archive.org/web/20150906155800/http://butunclebob.com/ArticleS.UncleBob.PrinciplesOfOod) – **OCP**, **ISP**, **DIP** (~S**O**L**ID**), REP, CRP, CCP, ADP
  * [1997](https://web.archive.org/web/20150906155800/http://butunclebob.com/ArticleS.UncleBob.PrinciplesOfOod) – SDP, SAP
  * ~[1997](https://web.archive.org/web/20180424095400/http://www.cs.ubc.ca/~gregor/papers/kiczales-ECOOP1997-AOP.pdf) – **面向方面编程**
  * ~1997 – Web 服务
  * ~[1997](https://www.oreilly.com/library/view/enterprise-service-bus/0596006756/) – **ESB** – 企业服务总线 (尽管创造该术语的书籍2004年才出版，但这个概念早已被使用)
- 21 世纪 00 年代
  * [2002](https://www.amazon.com/dp/0135974445) – **SRP** (~**S**OLID)
  * [2003](https://www.amazon.com/dp/0321125215) – **领域驱动设计**
  * [2005](https://web.archive.org/web/20180907204907/https://blogs.msdn.microsoft.com/johngossman/2005/10/08/introduction-to-modelviewviewmodel-pattern-for-building-wpf-apps/) – **MVVM 模式(Model-View-ViewModel)**
  * [2005](https://web.archive.org/web/20180822100852/http://alistair.cockburn.us/Hexagonal%2Barchitecture) – **端口和适配器架构**即六边形架构
  * [2006](https://youtu.be/JHGkaShoyNs?t=1m17s)? – **CQRS 与 ES** (命令查询职责分离与事件溯源)
  * [2008](https://jeffreypalermo.com/2008/07/the-onion-architecture-part-1/) – **洋葱架构**
...
- 21 世纪 10 年代
  ...
  * [2012](https://blog.cleancoder.com/uncle-bob/2012/08/13/the-clean-architecture.html) – **整洁架构**
  * [2014](https://web.archive.org/web/20220706183618/http://www.codingthearchitecture.com/2014/08/24/c4_model_poster.html) – C4 模型
