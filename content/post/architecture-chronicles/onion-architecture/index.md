...
简书：<https://www.jianshu.com/p/d87d5389c92a>
...
{{< figure src="2008-onion-architecture5.png" class="medium" >}}
...
洋葱架构在端口和适配器架构的基础之上增加了一些应用业务逻辑的内部组织，这些组织是基于领域驱动设计的概念划分的。
